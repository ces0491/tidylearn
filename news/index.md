...
- [`tl_coefficients()`](https://tidylearn.sheetsolved.com/reference/tl_coefficients.md)
  ...
  shrunken estimate would not cover at its stated rate.

- [`tl_table_coefficients()`](https://tidylearn.sheetsolved.com/reference/tl_table_coefficients.md)
  gained `conf_int`, `level` and `exponentiate`, passed through to
  [`tl_coefficients()`](https://tidylearn.sheetsolved.com/reference/tl_coefficients.md).
  Existing calls produce the same table as before.
...
- [`tl_coefficients()`](https://tidylearn.sheetsolved.com/reference/tl_coefficients.md)
  ...
  predictors, or a factor level with no observations — as a row with an
  `NA` estimate. [`summary()`](https://rdrr.io/r/base/summary.html)
  drops aliased terms from its coefficient matrix, so
  [`tl_table_coefficients()`](https://tidylearn.sheetsolved.com/reference/tl_table_coefficients.md)
