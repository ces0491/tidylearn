...
# Full URL
data <- tl_read_github(
  "https://github.com/user/repo/blob/main/data/dataset.csv"
)

# Shorthand
data <- tl_read_github("user/repo", path = "data/dataset.csv", ref = "main")
```

### Kaggle

Downloads datasets via the
[Kaggle CLI](https://github.com/Kaggle/kaggle-api). Install with
