...
object through `model$fit` or `km$model`.
...
The three criteria disagree, which is normal and worth saying plainly: the
elbow is a judgement call, silhouette favours well-separated compact clusters,
and the gap statistic compares against a null of no structure. Silhouette says
2 here because *versicolor* and *virginica* overlap; the botanical answer is
3.
