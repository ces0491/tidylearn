...
If dropping a handful of rows moves a coefficient materially, the coefficient
is a statement about those rows.
...
The slope of `mpg` on `wt` weakens as `hp` rises: weight costs less economy
in a car that was never economical.
